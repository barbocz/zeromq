...
public class testClassification {
	public static void main(String args[]) throws Exception{
		...
		DataSource source = new DataSource("C:\\Program Files\\Global Prime\\MQL4\\Files\\Trainings\\iris.arff");
		...
		//load new dataset
		DataSource source1 = new DataSource("C:\\Program Files\\Global Prime\\MQL4\\Files\\Trainings\\iris.arff");
